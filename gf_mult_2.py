"""gf_mult_2.py – Homomorphic nibble-wise GF(2^8) ×2 using ζ-domain 2-var polynomials.
...
def gf_mul_2(context: CKKS_EngineContext, ct_hi: Any, ct_lo: Any):
    ...
    hi_ct = _poly_eval(context, ct_hi, ct_lo, "hi")
    lo_ct = _poly_eval(context, ct_hi, ct_lo, "lo")
    return hi_ct, lo_ct
